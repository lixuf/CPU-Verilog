...
module ddr2ip_phy (
	...
	ddr2ip_phy_alt_mem_phy	ddr2ip_phy_alt_mem_phy_inst(
	...
	defparam
		ddr2ip_phy_alt_mem_phy_inst.FAMILY = "Cyclone IV E",
		ddr2ip_phy_alt_mem_phy_inst.MEM_IF_MEMTYPE = "DDR2",
		ddr2ip_phy_alt_mem_phy_inst.DLL_DELAY_BUFFER_MODE = "LOW",
		ddr2ip_phy_alt_mem_phy_inst.DLL_DELAY_CHAIN_LENGTH = 12,
		ddr2ip_phy_alt_mem_phy_inst.DQS_DELAY_CTL_WIDTH = 6,
		ddr2ip_phy_alt_mem_phy_inst.DQS_OUT_MODE = "DELAY_CHAIN2",
		ddr2ip_phy_alt_mem_phy_inst.DQS_PHASE = 6000,
		ddr2ip_phy_alt_mem_phy_inst.DQS_PHASE_SETTING = 2,
		ddr2ip_phy_alt_mem_phy_inst.DWIDTH_RATIO = 2,
		ddr2ip_phy_alt_mem_phy_inst.MEM_IF_DWIDTH = 16,
		ddr2ip_phy_alt_mem_phy_inst.MEM_IF_ADDR_WIDTH = 13,
		ddr2ip_phy_alt_mem_phy_inst.MEM_IF_BANKADDR_WIDTH = 3,
		ddr2ip_phy_alt_mem_phy_inst.MEM_IF_CS_WIDTH = 1,
		ddr2ip_phy_alt_mem_phy_inst.MEM_IF_CS_PER_RANK = 1,
		ddr2ip_phy_alt_mem_phy_inst.MEM_IF_DM_WIDTH = 2,
		ddr2ip_phy_alt_mem_phy_inst.MEM_IF_DM_PINS_EN = 1,
		ddr2ip_phy_alt_mem_phy_inst.MEM_IF_DQ_PER_DQS = 8,
		ddr2ip_phy_alt_mem_phy_inst.MEM_IF_DQS_WIDTH = 2,
		ddr2ip_phy_alt_mem_phy_inst.MEM_IF_OCT_EN = 0,
		ddr2ip_phy_alt_mem_phy_inst.MEM_IF_CLK_PAIR_COUNT = 1,
		ddr2ip_phy_alt_mem_phy_inst.MEM_IF_CLK_PS = 5999,
		ddr2ip_phy_alt_mem_phy_inst.MEM_IF_CLK_PS_STR = "5999 ps",
		ddr2ip_phy_alt_mem_phy_inst.MEM_IF_MR_0 = 1074,
		ddr2ip_phy_alt_mem_phy_inst.MEM_IF_MR_1 = 1092,
		ddr2ip_phy_alt_mem_phy_inst.MEM_IF_MR_2 = 0,
		ddr2ip_phy_alt_mem_phy_inst.MEM_IF_MR_3 = 0,
		ddr2ip_phy_alt_mem_phy_inst.PLL_STEPS_PER_CYCLE = 56,
		ddr2ip_phy_alt_mem_phy_inst.SCAN_CLK_DIVIDE_BY = 2,
		ddr2ip_phy_alt_mem_phy_inst.MEM_IF_DQSN_EN = 0,
		ddr2ip_phy_alt_mem_phy_inst.DLL_EXPORT_IMPORT = "EXPORT",
		ddr2ip_phy_alt_mem_phy_inst.MEM_IF_ADDR_CMD_PHASE = 90,
		ddr2ip_phy_alt_mem_phy_inst.RANK_HAS_ADDR_SWAP = 0;
endmodule
...
// Retrieval info:  <NETLIST_SECTION class="altera.ipbu.flowbase.netlist.model.DDRPHYMVCModel"  active_core="ddr2ip_phy_alt_mem_phy" >
...
// Retrieval info:      <PRIVATE name = "mem_if_preset" value="Custom (Micron MT47H32M16-5E)"  type="STRING"  enable="1" />
...
// Retrieval info:      <PRIVATE name = "alt_top" value="ddr2ip_phy_alt_mem_phy_seq_wrapper"  type="STRING"  enable="1" />
// Retrieval info:      <PRIVATE name = "family" value="Cyclone IV E"  type="STRING"  enable="1" />
// Retrieval info:      <PRIVATE name = "filename" value="ddr2ip_phy_alt_mem_phy_seq_wrapper.vo"  type="STRING"  enable="1" />
// Retrieval info:     </NAMESPACE>
// Retrieval info:     <NAMESPACE name = "simgen2">
// Retrieval info:      <PRIVATE name = "family" value="Cyclone IV E"  type="STRING"  enable="1" />
// Retrieval info:      <PRIVATE name = "command" value="--simgen_arbitrary_blackbox=+ddr2ip_phy_alt_mem_phy_seq_wrapper;+ddr2ip_phy_alt_mem_phy_reconfig;+ddr2ip_phy_alt_mem_phy_pll;+ddr2ip_phy_alt_mem_phy_delay --ini=simgen_tri_bus_opt=on"  type="STRING"  enable="1" />
// Retrieval info:      <PRIVATE name = "parameter" value="SIMGEN_INITIALIZATION_FILE=C:\intelFPGA_lite\workary\bishe\men\ddr\ip\ddr2/ddr2ip_phy_simgen_init.txt"  type="STRING"  enable="1" />
// Retrieval info:     </NAMESPACE>
...
// Retrieval info:      <PRIVATE name = "filename" value="ddr2ip_phy_syn.v"  type="STRING"  enable="1" />
// Retrieval info:     </NAMESPACE>
