...
module ddr2ip (
	...
	ddr2ip_controller_phy	ddr2ip_controller_phy_inst(
...
// Retrieval info:  <NETLIST_SECTION class="altera.ipbu.flowbase.netlist.model.DDRControllerMVCModel"  active_core="ddr2ip_controller_phy" >
...
// Retrieval info:      <PRIVATE name = "alt_top" value="ddr2ip_alt_mem_ddrx_controller_top"  type="STRING"  enable="1" />
// Retrieval info:      <PRIVATE name = "nativelink_excludes" value="ddr2ip_phy_alt_mem_phy_seq.vhd,ddr2ip_phy_alt_mem_phy_seq_wrapper.vhd,ddr2ip_phy_alt_mem_phy_seq_wrapper.v"  type="STRING"  enable="1" />
// Retrieval info:      <PRIVATE name = "family" value="Cyclone IV E"  type="STRING"  enable="1" />
// Retrieval info:      <PRIVATE name = "filename" value="ddr2ip_alt_mem_ddrx_controller_top.vo"  type="STRING"  enable="1" />
// Retrieval info:     </NAMESPACE>
// Retrieval info:     <NAMESPACE name = "simgen2">
// Retrieval info:      <PRIVATE name = "family" value="Cyclone IV E"  type="STRING"  enable="1" />
// Retrieval info:      <PRIVATE name = "command" value="--simgen_arbitrary_blackbox=+ddr2ip_alt_mem_phy_seq_wrapper;+ddr2ip_alt_mem_phy_reconfig;+ddr2ip_alt_mem_phy_pll;+ddr2ip_phy_alt_mem_phy_delay --ini=simgen_tri_bus_opt=on"  type="STRING"  enable="1" />
// Retrieval info:      <PRIVATE name = "parameter" value="SIMGEN_INITIALIZATION_FILE=C:\intelFPGA_lite\workary\bishe\men\ddr\ip\ddr2/ddr2ip_simgen_init.txt"  type="STRING"  enable="1" />
// Retrieval info:     </NAMESPACE>
...
// Retrieval info:      <PRIVATE name = "filename" value="ddr2ip_syn.v"  type="STRING"  enable="1" />
// Retrieval info:     </NAMESPACE>
